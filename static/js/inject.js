// Yandex.Metrika — counter 109529824
(function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)};
m[i].l=1*new Date();
for(var j=0;j<document.scripts.length;j++){if(document.scripts[j].src===r){return;}}
k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)}
)(window,document,'script','https://mc.yandex.ru/metrika/tag.js','ym');
ym(109529824,'init',{clickmap:true,trackLinks:true,accurateTrackBounce:true,webvisor:true});

// Market-Place / MPSU ads for printer-c.vercel.app
// Articles only: horizontal after 1st, 5th, and 9th safe paragraphs, corner sticker
(function () {
  var MPSU_SCRIPT_SRC = 'https://statika.mpsuadv.ru/scripts/11593.js';
  ...
  function initAds() {
    ...
    // Rotator Static ZBT printer-c.vercel.app horizontal 1 №45594
    insertAfterParagraph(45594, 1);
    // Rotator Static ZBT printer-c.vercel.app horizontal 2 №45595
    insertAfterParagraph(45595, 5);
    // Rotator Static ZBT printer-c.vercel.app horizontal 3 №45596
    insertAfterParagraph(45596, 9);
    // Rotator Recom V printer-c.vercel.app corner/floating №45734
    insertFloatingWidget(45734);
  }
